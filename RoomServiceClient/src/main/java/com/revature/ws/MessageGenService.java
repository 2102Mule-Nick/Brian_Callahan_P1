 ...
 * 2021-03-25T12:55:06.229-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "messageGenService",
                  wsdlLocation = "http://localhost:8081/SOAPGreeting/greetingservice?wsdl",
...
public class MessageGenService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8081/SOAPGreeting/greetingservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessageGenService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8081/SOAPGreeting/greetingservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
